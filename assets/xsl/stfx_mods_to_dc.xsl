...
-->
	...
	<xsl:template match="mods:extension">
		...
		<degree>
			...
			<discipline><xsl:value-of select="./etd:degree/etd:discipline"/></discipline>
			<grantor><xsl:value-of select="./etd:degree/etd:grantor"/></grantor>
		</degree>
	</xsl:template>
	...
	<xsl:template match="mods:identifier">
			...
			<xsl:choose>
				...
				<xsl:when test="@type">
					<xsl:choose>
						<xsl:when test="contains ('school department', $type)">
							<dc:description.note>
								<xsl:value-of select="."/>
							</dc:description.note>
						</xsl:when>
